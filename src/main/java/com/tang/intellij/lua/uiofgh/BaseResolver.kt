...
open class BaseResolver {
    ...
    private var _dofileMapNames: Array<String> = arrayOf("class", "import", "initlog", "initxlib", "initglobals", "initprotos", "initsound", "initmodule", "initgame", "msganalyse", "events", "initinput", "global")
